...
# load_test_dataset
from load_data_rbert import *
from custom.trainer import customTrainer
from models.custom_rbert import customRBERTForSequenceClassification
...
def main(args):
    ...
    test_id, test_dataset, test_label = load_test_dataset(test_dataset_dir, tokenizer, args.add_entity_marker,
    ...
    output.to_csv(f'./prediction/{args.model_name}/submission_{fold_num}_end.csv',
...
if __name__ == '__main__':
    ...
    for i in range(5):
        ...
        # entity_marker
        # added by sujeong;
        parser.add_argument("--add_entity_marker", type=str2bool, default=False,
                            help="If you want to add entity marker, set this argument True.")
        ...
        # added by sujeong;
        parser.add_argument("--data_preprocessing", type=str2bool, default=False,
