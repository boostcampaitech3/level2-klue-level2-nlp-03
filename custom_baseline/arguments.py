...
def get_args():
    ...
    parser.add_argument("--exp_name", type=str, required=False, default="test", help="wandb experiments name if needed")
    ...
    parser.add_argument(
        ...
        type=str,
        default="steps",
        help="evaluation strategy to adopt during training" "`no`:  No evaluation during training." "`steps`: Evaluate every `eval_steps`" "`epoch`: Evaluate every end of epoch.",
    )
    ...
    # added by seypark:
    parser.add_argument("--group_by_length", type=str2bool, default=True, help="using group by length(default:True)")
    parser.add_argument("--train_method", type=str, default="kfold", help="Choice training method(default: kfold, else origin train)")
    parser.add_argument("--precision", type=str, default="bf16", help="Using AMP method(default:bf16)")
    parser.add_argument("--accelerator", type=str, default="gpu", help="Choice train device(default:gpu)")
