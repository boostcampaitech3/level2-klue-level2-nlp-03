...
from transformers import AutoTokenizer, AutoConfig, AutoModelForSequenceClassification, RobertaPreTrainedModel, PreTrainedModel

from transformers.models.roberta.modeling_roberta import RobertaLayer, RobertaSelfAttention, RobertaSelfOutput, RobertaAttention, RobertaEncoder, RobertaEncoder, RobertaIntermediate
...
class RobertaEncoder(nn.Module):
    ...
    def forward(
        ...
        return BaseModelOutputWithPastAndCrossAttentions(
            last_hidden_state=hidden_states, past_key_values=next_decoder_cache, hidden_states=all_hidden_states, attentions=all_self_attentions, cross_attentions=all_cross_attentions,
        )
...
class RobertaClassificationLSTMHead(nn.Module):
    ...
    def __init__(self, config):
        super().__init__()
        self.lstm = nn.LSTM(config.hidden_size, config.hidden_size, batch_first=True, bidirectional=False)
