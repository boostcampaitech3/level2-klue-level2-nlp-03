...
path1 = './prediction/submission_0.csv' # 가져올 csv 파일 주소 입력 필수!
path2 = './prediction/submission_1.csv'
path3 = './prediction/submission_2.csv'
path4 = './prediction/submission_3.csv'
path5 = './prediction/submission_4.csv'
...
df1.to_csv(f'./prediction/submission_final.csv', index=False)