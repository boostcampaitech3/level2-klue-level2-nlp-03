...
def main(args):
  ...
  output.to_csv(f'./prediction/{args.model_name}/submission_{fold_num}_prepro10_5100.csv', index=False) # 최종적으로 완성된 예측한 라벨 csv 파일 형태로 저장.
  #### 필수!! ##############################################
  print('---- Finish! ----')
if __name__ == '__main__':    
  ...
  for i in range (5):
    ...
    parser.add_argument('--model_dir', type=str, default=f"./results/fold_{i}/checkpoint-5100/pytorch_model.bin")
